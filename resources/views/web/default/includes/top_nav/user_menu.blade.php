...
@else
    <div class="d-flex align-items-center ml-md-50" style="color: white !important;">
        <a href="/login" class="py-5 px-10 mr-10 text-dark-blue font-14" style="color: white !important;">{{ trans('auth.login') }}</a>
        <a href="/register" class="py-5 px-10 text-dark-blue font-14" style="color: white !important;">{{ trans('auth.register') }}</a>
    </div>
@endif
