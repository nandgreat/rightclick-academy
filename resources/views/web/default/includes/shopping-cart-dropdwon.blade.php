<div class="dropdown">
    <button type="button" {{ (empty($userCarts) or count($userCarts) < 1) ? 'disabled' : '' }} class="btn btn-transparent dropdown-toggle" id="navbarShopingCart" data-toggle="dropdown"
            aria-haspopup="true" aria-expanded="false" style="color: white !important; background-color: black !important;">
        <i data-feather="shopping-cart" style="color: white !important;" width="20" height="20" class="mr-10"></i>
    ...
    <div class="dropdown-menu" aria-labelledby="navbarShopingCart">
        <div class="d-md-none border-bottom mb-20 pb-10 text-right">
            <i class="close-dropdown" style="color: white !important;" data-feather="x" width="32" height="32" class="mr-10"></i>
        </div>
        <div class="h-100">
