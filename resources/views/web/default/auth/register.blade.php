                            ...
                            <div class="form-group">
                               ...
                               <div class="d-flex align-items-center wizard-custom-radio mt-5">
                                    <div class="wizard-custom-radio-item flex-grow-1">
                                        ...
                                        <label class="font-12 cursor-pointer px-15 py-10" for="role_user">Invidual</label>
                                    ...
                                    @foreach($selectRolesDuringRegistration as $selectRole)
                                        <div class="wizard-custom-radio-item flex-grow-1">
                                            ...
                                            <label class="font-12 cursor-pointer px-15 py-10" for="role_{{ $selectRole }}">Businesses</label>
                                        </div>
                                    @endforeach
                                         ...
                                         @foreach($selectRolesDuringRegistration as $selectRole)
                                        <div class="wizard-custom-radio-item flex-grow-1">
                                            <input type="radio" name="account_type" value="universities" id="role_universities" class="">
                                            <label class="font-12 cursor-pointer px-15 py-10" for="role_universities">Universities</label>
                                        </div>
                                    @endforeach
                                    
                                         @foreach($selectRolesDuringRegistration as $selectRole)
                                        <div class="wizard-custom-radio-item flex-grow-1">
                                            <input type="radio" name="account_type" value="governments" id="role_government" class="">
                                            <label class="font-12 cursor-pointer px-15 py-10" for="role_government">Governments</label>
                                        </div>
                                    @endforeach
