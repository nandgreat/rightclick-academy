...
<div class="container">
    <div class="row login-container">
        <div class="col-12 col-md-6 pl-0">
            <img src="{{asset('assets/admin/img/student_image.png')}}" class="img-cover" alt="Login">
        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="d-flex align-items-center wizard-custom-radio mt-5">
                            ...
                            <div class="wizard-custom-radio-item flex-grow-1">
                                ...
                                <label class="font-12 cursor-pointer px-15 py-10" for="role_{{ $selectRole }}">Parent</label>
                            </div>
                            <!-- @endforeach -->
